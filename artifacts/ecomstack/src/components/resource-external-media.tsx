...
import { Check, Copy, ExternalLink, FileText, PlayCircle } from "lucide-react";
    ...
    <section>
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <div className="flex flex-wrap gap-2">
          <Button type="button" size="sm" variant="outline" onClick={copyUrl} className="border-[#cbdacb] bg-white text-[#193C36] hover:bg-[#E8F1E6]">
