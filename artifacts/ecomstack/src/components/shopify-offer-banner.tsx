  ...
  return (
    <aside aria-label="Shopify offer" className="w-full bg-[#193C36] px-3 py-2 text-white sm:px-4">
      <div className="mx-auto flex min-h-7 max-w-6xl flex-wrap items-center justify-center gap-x-3 gap-y-1.5 text-center text-xs sm:flex-nowrap sm:text-sm">
        <span className="hidden rounded-full border border-white/35 px-2 py-0.5 text-[10px] font-bold tracking-[0.14em] text-[#E8F1E6] sm:inline-flex">
          SHOPIFY OFFER
        </span>
        <span className="offer-message-long font-medium">Start your Shopify store with Kamil&apos;s link</span>
        <span className="offer-message-short font-medium">Start your Shopify store</span>
        <a
        ...
        >
          View offer <ArrowUpRight aria-hidden="true" className="h-3.5 w-3.5" />
